...
import { createIncident, IncidentSeverity } from "@/lib/incident/incidentStore";
import { shouldAutoFix, generatePatch } from "@/lib/ai/patchAgent";
import { isGitHubConfigured, createAutoFixPR } from "@/lib/github/createPR";
import {
  sendSlackAlert,
  notifyFixCreated,
  notifyFixSkipped,
